...
<div className="cards-container">
    <a href="./install">
        <h6>Install</h6>
        <p>Learn how to install DeepSparse, SparseML, and SparseZoo.</p>
    </a>
</div>
...
<div className="cards-container">
    <a href="./deploy">
        <h6>Deploy</h6>
        <p>Learn how to deploy a SparseZoo or custom model with DeepSparse.</p>
    </a>
</div>
...
<div className="cards-container">
    <a href="./finetune">
        <h6>Fine-tune</h6>
        <p>Learn how to fine-tune a sparsified model using SparseML.</p>
    </a>
</div>
