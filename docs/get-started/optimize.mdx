...
We'll use a pre-trained, unoptimized 7b Llama 2 chat model from the SparseZoo.
...
<Tabs>
    <TabItem value="python" label="Python" default>
        ...
        model = SparseAutoModelForCausalLM.from_pretrained("zoo:llama2-7b-llama2_chat_llama2_pretrain-base")
        tokenizer = SparseAutoTokenizer.from_pretrained("zoo:llama2-7b-llama2_chat_llama2_pretrain-base")
        dataset = load_dataset("garage-bAInd/Open-Platypus")
